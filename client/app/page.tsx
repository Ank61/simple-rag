      ...
      <div className="w-full max-w-6xl h-full bg-white rounded-3xl overflow-hidden flex shadow-lg border border-[#e3eaf3]">
        ...
        <div className="w-[340px] bg-white border-r border-[#e3eaf3] flex flex-col">
          <div className="p-6 pb-2">
            <h1 className="text-xl font-bold mb-6 tracking-tight text-[#23272f]">
              CHAT A.I+
            </h1>
            <div className="flex gap-2 mb-6">
              ...
              <Button
                variant="outline"
                size="icon"
                className="rounded-full border-[#e3eaf3] text-[#6c63ff]"
              >
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <Button
                variant="link"
                className="text-xs text-[#6c63ff] p-0 font-medium"
              >
                Clear All
              </Button>
            </div>
          ...
          <div className="p-4 border-t border-[#e3eaf3]">
            <Button
              variant="ghost"
              className="w-full justify-start text-[#23272f] hover:bg-[#f5f7fa] font-medium"
            >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <p className="text-sm text-[#23272f] font-medium">
                        Create a chatbot gpt using python language what will be
                        step for that
                      </p>
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-8 w-8 p-0 hover:bg-[#f5f7fa]"
                      >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <div className="text-xs text-[#6c63ff] font-semibold">
                        CHAT A.I+ <span className="ml-1">🤖</span>
                      </div>
                      <Button
                        variant="ghost"
                        size="sm"
                    ...
                    <div className="text-sm space-y-4 text-[#23272f]">
                      <p>
                        <span className="font-semibold">
                          Sure, I can help you get started with creating a
                          chatbot using GPT in Python. Here are the basic steps
                      ...
                      <ol className="list-decimal pl-5 space-y-2">
                        <li>
                          ...
                          You'll need to install the transformers library from
                          Hugging Face to use GPT. You can install it using pip.
                        </li>
                        <li>
                          <span className="font-semibold">
                            Load the pre-trained model:
                          </span>{" "}
                          GPT comes in several sizes and versions, so you'll
                          need to choose the one that fits your needs. You can
                          load a pre-trained GPT model. This loads the 1.3B
                          parameter version of GPT-Neo, which is a powerful and
                        ...
                        <li>
                          ...
                          You'll need to create a loop that takes user input,
                          generates a response using the GPT model, and outputs
                          it to the user. Here's an example loop that uses the
                          input() function to get user input and the gpt()
                          function to generate a response. This loop will keep
                          running until the user exits the program or the loop
                          is interrupted.
                        </li>
                        <li>
                          <span className="font-semibold">
                          ...
                          While GPT can generate text, it doesn't have any
                          inherent personality or style. You can make your
                          chatbot more interesting by adding custom prompts or
                          responses that reflect your desired personality. You
                          can then modify the chatbot loop to use these prompts
                          and responses when appropriate. This will make the
                          chatbot seem more human-like and engaging.
                        </li>
                      </ol>
                      <p>
                        <span className="font-semibold">
                          These are just the basic steps to get started with a
                          GPT chatbot in Python.
                        </span>{" "}
                        Depending on your requirements, you may need to add more
                    ...
                    <div className="flex items-center gap-2 mt-4">
                      <Button
                        variant="outline"
                        size="icon"
                        className="rounded-full h-8 w-8 border-[#e3eaf3] hover:bg-[#f5f7fa]"
                      >
                      ...
                      <div className="ml-auto">
                        <Button
                          variant="outline"
                          size="sm"
                          className="rounded-full text-xs border-[#e3eaf3] hover:bg-[#f5f7fa]"
                        >
          ...
          <div className="p-6 border-t border-[#e3eaf3] bg-white">
            <div className="max-w-3xl mx-auto relative flex items-center gap-2">
              ...
              <input
                ...
                ref={fileInputRef}
                onChange={(e) => {
                  console.log("PDF input change detected");
              ...
              <div className="flex-1 relative">
                <div className="absolute right-0 top-0 h-full flex items-center pr-3">
                  <Button
                    size="icon"
                    variant="ghost"
                    className="rounded-full bg-[#6c63ff] text-white h-8 w-8 hover:bg-[#554ee2]"
                  >
